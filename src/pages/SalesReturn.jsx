...
//     try {
//       const res = await axios.get("https://billing-system-zykh.onrender.com/returns");
//       setReturns(res.data);
//     } catch {
...
//     try {
//       const res = await axios.get(`https://billing-system-zykh.onrender.com/sales/${saleId}`);
//       setSale(res.data);
//     } catch {
...
//         const p = await axios.get(`https://billing-system-zykh.onrender.com/products/${item.id}`);

//         await axios.put(`https://billing-system-zykh.onrender.com/products/${item.id}`, {
//           ...p.data,
...
//       // 🔥 MARK SALE RETURNED
//       await axios.put(`https://billing-system-zykh.onrender.com/sales/${sale.id}`, {
//         ...sale,
//         returned: true,
//       });
...
const SalesReturn = () => {
  ...
  const fetchSale = async () => {
    ...
    try {
      const res = await axios.get(`${BASE_URL}/sales/${saleId}`);
      setSale(res.data);
    } catch {
      toast.error("Sale not found ❌");
      setSale(null);
  ...
  const handleReturn = async () => {
    ...
    try {
      // 🔥 UPDATE STOCK
      for (let item of sale.items) {
        const p = await axios.get(`${BASE_URL}/products/${item.id}`);
      ...
      // 🔥 MARK SALE RETURNED
      await axios.put(`${BASE_URL}/sales/${sale.id}`, {
        ...sale,
        returned: true,
      });
